...
(def ^:large-vars/data-var dicts
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
   ...
   :ja {:tutorial/text (rc/inline "tutorial-ja.md")
        ...
        :on-boarding/open-local-dir "ここをクリックしてローカルフォルダを選んでください"
        ...
        :settings-page/git-switcher-label "Gitの自動込みとを有効化"
        ...
        :settings-page/enable-all-pages-public "パブリッシュ自には全てのページを公開する"
